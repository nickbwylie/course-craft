  ...
  return (
    <div className="max-w-3xl mx-auto px-8 py-8">
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <p className="text-slate-600 dark:text-slate-400">
          Welcome to CourseCraft. These Terms of Service ("Terms") govern your
          access to and use of the CourseCraft platform, including any content,
          functionality, and services offered on or through CourseCraft.
        </p>
        ...
        <p className="text-slate-600 dark:text-slate-400">
          This service is available to users who are 13 years of age or older.
          If you are under 13 years old, you may not use this service. If you
          are between 13 and 18 years old, you may only use this service with
          the consent and supervision of a parent or legal guardian who agrees
        ...
        <p className="text-slate-600 dark:text-slate-400">
          Our service allows you to create and share educational content ("User
          Content"). You retain all rights in, and are solely responsible for,
          the User Content you create, post, or display on or through our
          service.
        </p>
        <p className="text-slate-600 dark:text-slate-400 mt-2">
          By creating or sharing User Content on or through our service, you
          grant us a non-exclusive, royalty-free, transferable, sublicensable,
          worldwide license to use, store, display, reproduce, modify, create
          derivative works, and distribute your User Content on or through our
          service.
        </p>
        <p className="text-slate-600 dark:text-slate-400 mt-2">
        ...
        <ul className="list-disc pl-6 mt-2 space-y-2 text-slate-600 dark:text-slate-400">
          ...
          <li>
            The creation, posting, or display of your User Content on or through
            our service does not violate the privacy rights, publicity rights,
        ...
        <p className="text-slate-600 dark:text-slate-400">
          ...
          based on YouTube content. By using our service, you are also agreeing
          to be bound by the{" "}
          <a
        ...
        <p className="text-slate-600 dark:text-slate-400">
          ...
          YouTube content), features, and functionality are and will remain the
          exclusive property of CourseCraft and its licensors. Our service is
        ...
        <ul className="list-disc pl-6 mt-2 space-y-2 text-slate-600 dark:text-slate-400">
          ...
          <li>
            To impersonate or attempt to impersonate CourseCraft, a CourseCraft
            employee, another user, or any other person or entity.
          </li>
          <li>
            To engage in any other conduct that restricts or inhibits anyone's
            use or enjoyment of the service, or which, as determined by us, may
            harm CourseCraft or users of the service or expose them to
            liability.
          </li>
        </ul>
        ...
        <p className="text-slate-600 dark:text-slate-400">
          In no event shall CourseCraft, nor its directors, employees, partners,
